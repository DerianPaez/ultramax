...
export const Navigation = () => {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border bg-white/95 backdrop-blur-md shadow-sm transition-all duration-300">
      <div className="mx-auto flex max-w-7xl h-20 items-center justify-between px-6 lg:px-8">
        <Link href="/" className="flex items-center group shrink-0">
          <Image
            ...
            width={160}
            height={36}
            className="h-3.5 sm:h-4 lg:h-5 xl:h-6 w-auto object-contain group-hover:scale-105 transition-transform duration-200"
            priority
          />
        </Link>
